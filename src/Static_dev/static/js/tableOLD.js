...
$('.table-add1').on('click', 'i', () => {
		...
		<tr class="hide">
			...
			<td class="pt-3-half" contenteditable="true" ans >A</td>
			<td class="pt-3-half" contenteditable="true" marks>${defcmarks}</td>
			<td class="pt-3-half" contenteditable="true" wmarks>${defwmarks}</td>
			<td class="pt-3-half" contenteditable="true">${defsub}</td>
...
// Here the code is for Add (Single row)
